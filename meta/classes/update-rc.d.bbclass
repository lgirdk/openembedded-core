...
def get_target_depends(d):
    if bb.utils.contains('DISTRO_FEATURES', 'sysvinit', True, False, d):
        return 'update-rc.d-native update-rc.d initscripts'
    if d.getVar('VIRTUAL-RUNTIME_init_manager', True) == 'busybox':
        return 'update-rc.d-native update-rc.d'
    return ''
...
def get_packagesplit_funcs(d):
    if bb.utils.contains('DISTRO_FEATURES', 'sysvinit', True, False, d) or d.getVar('VIRTUAL-RUNTIME_init_manager', True) == 'busybox':
